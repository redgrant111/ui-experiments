    ...
    <SettingsPanelProvider>
      <SidebarProvider>
        ...
        <SidebarInset className="bg-sidebar group/sidebar-inset">
          ...
          <div className="flex h-[calc(100svh-4rem)] bg-[hsl(240_5%_92.16%)] dark:bg-[hsl(240_10%_3.9%)] md:rounded-s-3xl md:group-peer-data-[state=collapsed]/sidebar-inset:rounded-s-none transition-all ease-in-out duration-300">
            <Chat />
          </div>
        </SidebarInset>
      </SidebarProvider>
